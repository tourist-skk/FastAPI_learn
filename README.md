...
| 范围 | 内容 |
| --- | --- |
| `00-python基础补充` | 类型注解、pathlib、同步与异步、上下文管理器、SQLite、ORM、SQLAlchemy、Pydantic 等 |
| `01-12` | FastAPI 简介、安装、路由、路径/查询/请求体参数、响应类型、异常处理 |
| `13-27` | 中间件、依赖注入、ORM 建表与增删改查、多表查询等 |
| `28` | 实战项目（新闻浏览）项目物料 |
| `29-33` | 模块化路由、数据库与 ORM 配置、新闻分类/列表/详情接口 |
| `34-40` | 注册登录、通用成功响应、全局异常处理、用户资料与密码 |
| `41-44` | 新闻收藏状态检查、添加/删除/列表 |
| `45-48` | Redis 缓存：安装、封装操作、设计缓存策略、缓存新闻列表 |
