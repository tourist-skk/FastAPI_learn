...
你写的全局异常处理函数本身不是中间件，但框架通过内置的异常处理中间件来使用它。
可以把它们理解为两种分工：

   角色              负责什么
  ━━━━━━━━━━━━━━━━  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   异常处理中间件    捕获异常、查找应该调用哪个处理函数
  ────────────────  ────────────────────────────────────
   异常处理函数      接收异常，决定返回什么响应

 FastAPI 底层的 Starlette 已经提供了相关中间件：

  - ExceptionMiddleware：处理已注册的具体异常，例如你的 IntegrityError。
  - ServerErrorMiddleware：处理继续向外传播的未处理异常，使用 Exception 或 500 对应的兜底处理函数。Starlette 官方说明
